            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div className="flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="flex items-center space-x-4 mt-2 sm:mt-0">
                        ...
                        <a href="https://x.com/anuj_549" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm mt-2 sm:mt-0">
                        Developed by <a href="https://github.com/Anuj579" target="_blank" rel="noopener noreferrer" className="text-gray-800 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400"><span className='font-medium'>AnujChaudhary</span></a>
                    </p>
                </div>
            </div>
        </footer>
